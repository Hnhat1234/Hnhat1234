...
int main(){
    ...
    for (int i = 1;i <= n;++i){
        for (int j = 1;j <= m;++j){
            ...
            check = min(check,(a[i + 3][j] == '.'));
            check = min(check,(a[i + 3][j + 1] == '.'));
            check = min(check,(a[i + 3][j + 2] == '.'));
            check = min(check,(a[i][j + 3] == '.'));
            check = min(check,(a[i + 1][j + 3] == '.'));
            check = min(check,(a[i + 2][j + 3] == '.'));
            check = min(check,(a[i + 3][j + 3] == '.'));
            check = min(check,(a[x - 3][y] == '.'));
            check = min(check,(a[x - 3][y - 1] == '.'));
            check = min(check,(a[x - 3][y - 2] == '.'));
            check = min(check,(a[x][y - 3] == '.'));
            check = min(check,(a[x - 1][y - 3] == '.'));
            check = min(check,(a[x - 2][y - 3] == '.'));
            check = min(check,(a[x - 3][y - 3] == '.'));
            if (check){s.insert({i,j});}
        }
    }
    for (ii p : s){
